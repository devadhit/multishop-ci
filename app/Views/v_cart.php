                                        ...
                                        <td class="align-middle">
                                            <div class="input-group" width="100px">
                                                <div class="button minus">
                                                    <a href="/cart/minus/<?php echo $item['id']; ?>" type="button" class="btn btn-primary btn-number" data-type="minus"><i class="fa fa-minus"></i></a>
                                                </div>
                                                <input type="hidden" size="1" name="kode" class="input-number" data-min="1" data-max="100" value="<?php echo $item['id']; ?>">
                                                <input type="text" size="1" name="ganti" class="input-number" data-min="1" data-max="100" value="<?php echo $item['quantity']; ?>">
                                                <div class="button plus">
                                                    <a href="/cart/plus/<?php echo $item['id']; ?>" type="button" class="btn btn-primary btn-number" data-type="plus"><i class="fa fa-plus"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle" class="total-amount" data-title="Total"><span><?php echo $item["quantity"] * $item["harga_barang"] ?></span></td>
                                        <td class="align-middle" class="action" data-title="Remove"><a href="/cart/remove/<?php echo $item["id"]; ?>"><i class="fa fa-trash remove-icon"></i></a></td>
                                    </tr>
                                <?php
