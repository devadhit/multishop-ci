                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/displayInput" class="nav-item nav-link">Input Data Barang</a>
                        </div>
                        <div class="navbar-nav mr-1 py-0 d-none d-lg-block">
                            ...
                            <a href="/cart" class="btn px-0 ml-3">
                                ...
                                <span class="badge badge-default">
                                    ...
                                    if (!session()->get('cart_item')) {
                                        ...
                                        echo count(session()->get('cart_item'));
                                    }
                                    ?>
                                </span>
                            </a>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="template/img/payments.png" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
